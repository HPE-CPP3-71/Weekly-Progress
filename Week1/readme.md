...
- Conducted initial research on network packet anomalies.
- Reviewed different anomaly detection techniques.
- Explored AI/ML approaches used in network anomaly detection.
