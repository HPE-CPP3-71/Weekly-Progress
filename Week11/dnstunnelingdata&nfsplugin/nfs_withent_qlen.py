...
if __name__ == '__main__':
    ...
    streamer = NFStreamer(
        source="dns_benign_2.pcap",  
        statistical_analysis=True,
        splt_analysis=0,
        accounting_mode=3,           
        udps=[BulkPlugin(),HeaderLenPlugin(),InitWindowPlugin(),FlowEntropyPlugin(),QueryLengthPlugin(),ExtraFeaturesPlugin(),ActiveIdlePlugin(idle_threshold_ms=5000)]   
    )

    output_filename = "dns_benign_2.csv"
    ...
    final_filename = "dns_benign_2_processed.csv"
