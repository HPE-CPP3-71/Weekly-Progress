...
def extract_features_to_csv(pcap_path, csv_path):
    """
    Reads a PCAP file, applies custom NFStream plugins, and exports the flows to a CSV.
    """
    ...
    post_process_cicflowmeter(output_filename, csv_path)
   
if __name__ == "__main__":
    
    # r"C:\Users\magan\Downloads\HPE Project\Week 10\PortScan and Brute force PCAP\FTP_SSH_benign.pcap"
    # r"FTP_SSH_benign1.csv"
    # r"C:\Users\magan\Downloads\Additional ftp ssh benign.pcap"
    # r"FTP_SSH_benign2.csv"
    #  r"C:\Users\magan\Downloads\HPE Project\Week 10\PortScan and Brute force PCAP\New_benign_PSBF.pcap"
    # r"Web_Benign_Traffic1.csv"
    # r"C:\Users\magan\Downloads\HPE Project\Week 11\ICMP Flood PCAPS\web_benign_icmpfl.pcap"
    # r"Web_Benign_Traffic2.csv"
    # r"C:\Users\magan\Downloads\ICMP FL and PSBF PCAPS\NATbenignICMP.pcap"
    # r"Web_Benign_Traffic3.csv"
    # r"C:\Users\magan\Downloads\ICMP FL and PSBF PCAPS\Additional web benign.pcap"
    # r"Web_Benign_Traffic4.csv"
    # r"C:\Users\magan\Downloads\ICMP FL and PSBF PCAPS\Additional web benign2.pcap"
    # r"Web_Benign_Traffic5.csv"
    # r"C:\Users\magan\Downloads\HPE Project\Week 10\PortScan and Brute force PCAP\PortBrute_attack.pcap"
    # r"PortBrute_Attack1.csv"
    #  r"C:\Users\magan\Downloads\HPE Project\Week 11\Port Scan PCAPS\ftp_brute_only.pcap"
    # output_csv = r"FTP_BruteForce_Attack2.csv"
    # r"C:\Users\magan\Downloads\HPE Project\Week 11\Port Scan PCAPS\ssh_brute_only.pcap"
    # output_csv = r"SSH_BruteForce_Attack3.csv"
    # r"C:\Users\magan\Downloads\HPE Project\Week 11\Port Scan PCAPS\Additional PSBF PCAP.pcap"
    # output_csv = r"PortBrute_Attack5.csv"
    # r"C:\Users\magan\Downloads\ICMP Tunneling PCAPS\Hostonlyicmp.pcap"
    # output_csv = r"ICMP_Tunneling_Attack1.csv"
    # r"C:\Users\magan\Downloads\ICMP Tunneling PCAPS\Additional_capture_scapy_test2.pcap"
    # output_csv = r"ICMP_Tunneling_Attack2.csv"
    # r"C:\Users\magan\Downloads\ICMP Tunneling PCAPS\additional_scapy_test3.pcap"
    # output_csv = r"ICMP_Tunneling_Attack3.csv"
    # r"C:\Users\magan\Downloads\ICMP Tunneling PCAPS\additionalptunnel.pcap"
    # output_csv = r"ICMP_Tunneling_Attack4.csv"
    # r"C:\Users\magan\Downloads\ICMP Tunneling PCAPS\additionalptunnel2.pcap"
    # output_csv = r"ICMP_Tunneling_Attack5.csv"
    #  r"c:\Users\magan\Downloads\ICMP Tunneling PCAPS\additional_benign_icmp.pcap"
    # output_csv = r"ICMP_Tunneling_Benign1.csv"
    # r"C:\Users\magan\Downloads\ICMP Tunneling PCAPS\Additional_benign_icmp2.pcap"
    # output_csv = r"ICMP_Tunneling_Benign2.csv"
    
    
    input_pcap = r"C:\Users\magan\Downloads\ICMP Tunneling PCAPS\Additional_benign_icmp2.pcap"
    output_csv = r"ICMP_Tunneling_Benign2.csv"
    
    extract_features_to_csv(input_pcap, output_csv)
    
    if os.path.exists(output_csv):
        df = pd.read_csv(output_csv)
        print(f"\nDataset successfully loaded into Pandas.")
        print(f"Shape for model training (Flows, Features): {df.shape}")