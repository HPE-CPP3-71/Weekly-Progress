...
| Person | Work Done |
|------|------|
| Phani | Tested the Isolation forest model on the generated dataset. Trained different models (Isolation Forest, Xgboost, One Class SVM) on ICMP attack Dataset. |
